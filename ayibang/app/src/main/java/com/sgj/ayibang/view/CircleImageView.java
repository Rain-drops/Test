...
public class CircleImageView extends ImageView {
    ...
    private static final int DEFAULT_BORDER_WIDTH = 0;// 默认的边框宽度
    private static final int DEFAULT_BORDER_COLOR = Color.BLACK;// 默认的边框颜色
    ...
    private final RectF mBorderRect = new RectF(); // 边界矩形
